...
<div class="container">
         <div class="row">
              <div class="col-md-12">
                   <h2 class="bg-warning text-black text-center p-3 mt-5">Delete Form</h2>
              </div>
         </div>
     <div class="row">
          <div class="col-md-12 mt-3">
            <form action="" method="">
              <div class="form-row">
                  ...
                  <input type="submit" name="btnsearch" class="btn btn-dark mt-3" value="Delete Data">
                  </form>
              </div>
          </div>
     </div>
       ...
       <div class="row mt-3">
            <div class="col-md-12">
                <form action="Allquery.php" method="post">
                    ...
                    <?php } ?>
                    <input type="submit" name="btndelete" class="btn btn-primary mt-3" value="Delete Data">
                </form>
            </div>
       </div>
  </div>
